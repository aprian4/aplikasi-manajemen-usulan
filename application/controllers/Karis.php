...
class Karis extends CI_Controller
{
    ...
    public function detail_karis($id)
    {
        ...
        foreach ($data['detail_usulan'] as $lu) {
            ...
            if ($data['usulan']['jenis_usulan'] == "karis_baru") {
                ...
                $berkas6 = 'LAMPIRAN_XXX_KARIS_' . $lu['nip'];
                $berkas7 = 'LAMPIRAN_XXXI_KARIS_' . $lu['nip'];
                $berkas8 = 'KEHILANGAN_KARIS_' . $lu['nip'];
            }
            $berkas2 = 'SK_LAP_KAWIN_' . $lu['nip'];
            $berkas3 = 'KELUARGA_' . $lu['nip'];
            $berkas5 = 'FOTO_ISTRI_' . $lu['nip'];
    ...
    public function riwayat_berkas($nip = null, $id_usulan = null, $jenis_usulan = null)
    {
        ...
        $namaberkas_kehilangankaris = null;
        ...
        if ($jenis_usulan == "karis_baru") {
            ...
            $namaberkas_lampiranxxx = "LAMPIRAN_XXX_KARIS_" . $nip;
            $namaberkas_lampiranxxxi = "LAMPIRAN_XXXI_KARIS_" . $nip;
            $namaberkas_kehilangankaris = "KEHILANGAN_KARIS_" . $nip;
            ...
            $data['berkas_kehilangankaris'] = $this->db->get_where('berkas', ['nip' => $nip, 'nama_berkas' => $namaberkas_kehilangankaris])->row_array();
        }
        $namaberkas_suratnikah = "SURAT_NIKAH_" . $nip;
        $namaberkas_lapkawin = "SK_LAP_KAWIN_" . $nip;
        $namaberkas_keluarga = "KELUARGA_" . $nip;
        $namaberkas_fotoistri = "FOTO_ISTRI_" . $nip;
        ...
        $data['berkas_fotoistri'] = $this->db->get_where('berkas', ['nip' => $nip, 'nama_berkas' => $namaberkas_fotoistri])->row_array();
    ...
    public function upload_berkas($nip = null, $id_usulan = null, $jenis_usulan = null)
    {
        ...
        foreach ($detail_usulan as $lu) {
            if ($jenis_usulan == "karis_baru") {
                ...
                $berkas6 = "LAMPIRAN_XXX_KARIS_" . $nip;
                $berkas7 = "LAMPIRAN_XXXI_KARIS_" . $nip;
    ...
    public function hapus_berkas_karis($id_berkas = null, $id_usulan = null, $namabks = null)
    {
    ...
    public function crud_upload($pg)
    {
        ...
        if ($pg == 'suratpengantar') {
        ...
        } else if ($pg == 'fotoistri') {
            $jenis_usulan = $this->input->post('jenis_usulan');
            $this->load->helper('url');

            $nip = $this->input->post('nip');
            $namaberkas = "FOTO_ISTRI_" . $nip;
            $id_usulan = $this->input->post('id_usulan');
            ...
            $nip = $this->input->post('nip');
            $namaberkas = "LAMPIRAN_XXX_KARIS_" . $nip;
            $id_usulan = $this->input->post('id_usulan');
            ...
            $nip = $this->input->post('nip');
            $namaberkas = "LAMPIRAN_XXXI_KARIS_" . $nip;
            $id_usulan = $this->input->post('id_usulan');
