                ...
                <div class="card author-box card-light">
                    ...
                    <div class="card-body">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <select class="custom-select" name='jenis_usulan' required>
                                                <option <?php if ($usulan['jenis_usulan'] == 'idcard_baru') {
                                                            echo "selected='selected'";
                                                        } ?> value="idcard_baru">Pembuatan Kartu Tanda Pengenal (Idcard)</option>
                                                <option <?php if ($usulan['jenis_usulan'] == 'idcard_pengganti') {
                                                            echo "selected='selected'";
                                                        } ?> value="idcard_pengganti">Pembuatan Kartu Tanda Pengenal (Idcard) Pengganti Karena Hilang</option>
                                            </select>
                                        </div>
                        ...
                        <div class="card mb-3 col-lg-12">
                            <table id="table-detail_idcard" style="font-size: 15px;" class="table table-striped dt-responsive" width="100%">
                                <thead>
                                    <tr>
                                        <th scope="col">No</th>
                                        <th scope="col">NIP</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <!-- Modal -->
                                                        <form method="POST" action="<?= base_url('idcard/crud_usulan_detail_idcard/lengkapidata/' . $lu['nip']); ?>">
