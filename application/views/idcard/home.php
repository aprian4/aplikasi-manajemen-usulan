                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php } else if ($r['status_usulan'] == 2) { ?>
                                                        <span class="badge badge-warning">Proses Cetak</span>
                                                    <?php } else if ($r['status_usulan'] == 3) { ?>
                                                        <span class="badge badge-primary">Selesai Cetak</span>
                                                    <?php } ?>
                                                </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown show">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                ...
                                                                <button type="button" class="dropdown-item" data-toggle="modal" data-target="#editStatusModal<?= $i ?>"><i class="fas fa-check-square fa-sm"></i> Proses Cetak</a></button>
                                                        ...
                                                        <form method="POST" action="<?= base_url('idcard/crud_usulan_idcard/ubahstatus'); ?>">
                                                            <div class="modal fade" id="editStatusModal<?= $i ?>" tabindex="-1" aria-labelledby="editStatusModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title text-center" id="editStatusModalLabel">Apakah Anda Yakin Akan Memproses Data ini untuk Dicetak?</h5>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <select class="custom-select" name='status_usulan' required>
                                                                                ...
                                                                                <option <?php if ($r['status_usulan'] == '2') {
                                                                                            echo "selected='selected'";
                                                                                        } ?> value="2">Proses Cetak</option>
                                                                                <option <?php if ($r['status_usulan'] == '3') {
                                                                                            echo "selected='selected'";
                                                                                        } ?> value="3">Selesai Cetak</option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <button type="submit" class="btn btn-danger">Ya</button>
