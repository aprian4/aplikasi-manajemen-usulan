                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <div id="formDisetujui">
                                                                                ...
                                                                                <?php if ($path_berkas != null) { ?>
                                                                                    ...
                                                                                    <a style="color:#fff" class="lihat btn btn-danger btn-sm" href="<?= base_url('idcard/hapus_berkas_idcard/' . $id_berkas . '/' . $usulan['id'] . '/' . $nama_berkas); ?>" role="button"><i class="fas fa-times-circle"></i> Batal</a>
                                                                                <?php } else { ?>
