                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php } else { ?>
                                            <form method='post' action='<?php echo base_url('karis/crud_upload/lapkawin'); ?>' enctype='multipart/form-data'>
                                                <input type='file' name='file'>
                                                <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php } else { ?>
                                            <form method='post' action='<?php echo base_url('karis/crud_upload/keluarga'); ?>' enctype='multipart/form-data'>
                                                <input type='file' name='file'>
                                                <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                ...
                                <?php if ($usulan['jenis_usulan'] == "karis_baru") { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php } else { ?>
                                                <form method='post' action='<?php echo base_url('karis/crud_upload/kematian'); ?>' enctype='multipart/form-data'>
                                                    <input type='file' name='file'>
                                                    <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                    <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                    <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php } else { ?>
                                            <form method='post' action='<?php echo base_url('karis/crud_upload/suratnikah'); ?>' enctype='multipart/form-data'>
                                                <input type='file' name='file'>
                                                <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                ...
                                <tr>
                                    ...
                                    <td><label class="col-sm-12 col-md-12">Pas foto istri hitam putih ukuran 3x4 cm <br><b> (Max. Ukuran File 2MB dan Format File .pdf)</b></label></td>
                                    <td>
                                        <?php if ($berkas_fotoistri != null) { ?>
                                                ...
                                                <div class="modal fade" id="hapusBerkas5" tabindex="-1" aria-labelledby="hapusBerkas5Label" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                            <input type="text" name="id_berkas" value="<?= $berkas_fotoistri['id']; ?>" hidden>
                                                            <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                            <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                                            <input type='text' name='path' value="<?= $berkas_fotoistri['path']; ?>" hidden>
                                                            <div class="modal-footer">
                                                                <button type="submit" class="btn btn-danger">Ya</button>
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                            </div>
                                            ...
                                            <form method='post' action='<?php echo base_url('karis/crud_upload/fotoistri'); ?>' enctype='multipart/form-data'>
                                                <input type='file' name='file'>
                                                <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($berkas_lampiranxxx != null) { ?>
                                                ...
                                                <form method='post' action='<?php echo base_url('karis/crud_upload/lampiranxxx'); ?>' enctype='multipart/form-data'>
                                                    <input type='file' name='file'>
                                                    <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                    <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                    <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($berkas_lampiranxxxi != null) { ?>
                                                ...
                                                <form method='post' action='<?php echo base_url('karis/crud_upload/lampiranxxxi'); ?>' enctype='multipart/form-data'>
                                                    <input type='file' name='file'>
                                                    <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                    <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                    <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($berkas_kehilangankaris != null) { ?>
                                                    ...
                                                    <div class="modal fade" id="hapusBerkas8" tabindex="-1" aria-labelledby="hapusBerkas8Label" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                                <input type="text" name="id_berkas" value="<?= $berkas_kehilangankaris['id']; ?>" hidden>
                                                                <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                                <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
                                                                <input type='text' name='path' value="<?= $berkas_kehilangankaris['path']; ?>" hidden>
                                                                <div class="modal-footer">
                                                                    <button type="submit" class="btn btn-danger">Ya</button>
                                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                </div>
                                                ...
                                                <form method='post' action='<?php echo base_url('karis/crud_upload/kehilangankaris'); ?>' enctype='multipart/form-data'>
                                                    <input type='file' name='file'>
                                                    <input type="text" name="jenis_usulan" value="<?= $usulan['jenis_usulan']; ?>" hidden>
                                                    <input type='text' name='nip' value="<?= $nip; ?>" hidden>
                                                    <input type='text' name='id_usulan' value="<?= $id_usulan; ?>" hidden>
