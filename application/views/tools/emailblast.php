        ...
        <div class="container-fluid">
            ...
            <div class="col-12 col-sm-12 col-lg-12">
                <div class="card author-box card-light">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?= base_url('Email/crud_blast'); ?>">
                            <div class="form-group">
                                <label for="forSubjek">Subjek</label>
                                <input type="text" name="subjek" class="form-control" id="forSubjek" rows="3"></input>
                            </div>
                            <div class="form-group">
